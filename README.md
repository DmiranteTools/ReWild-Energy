...
Il nostro strumento non richiede alcuna installazione o software esterno, e la sua installazione è immediata e di facile utilizzo. Basterà:
  1. Scaricare il pacchetto del programma dal [Google Drive] dedicato (https://drive.google.com/drive/folders/1Yhx_tbX9OaCDAE1-4dk9IDuoBcffeK0t?usp=sharing) (formato `.zip`).
